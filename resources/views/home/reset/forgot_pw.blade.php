...
@section('content')
    <img src="{{ asset("/bower_components/AdminLTE/dist/img/odin_logo_current.png") }}" alt="Odin Logo" height="60px" width="200px" style="position: absolute; left:30px; top:30px;"/>
