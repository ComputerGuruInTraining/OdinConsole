...
Route::get("/active/test", function () {

//    $token = session('token');
    //    $key = '7b60b3914bd330fe2f29461d391133847685111e2f6910dec5aa16627ea83bf82c1ecfb9';
...
//    $body = rawurlencode("email=odinlitemail@gmail.com&tags=PAID CUSTOMER");
//    dd($body);

    // here we define the data we are posting in order to perform an update
    $post = array(
        'email'                    => 'odinlitemail@gmail.com',
        'tags'                     => 'Paid Customer',
...
// This section takes the input data and converts it to the proper format
    ...
    $url = "https://odin.api-us1.com";
    // clean up the url
    $url = rtrim($url, '/ ');

    $api = $url . '/admin/api.php?' . $query;

//    $url = "https://odin.api-us1.com/admin/api.php?api_action=contact_sync?api_output=json?api_key=7b60b3914bd330fe2f29461d391133847685111e2f6910dec5aa16627ea83bf82c1ecfb9";



    $client = new GuzzleHttp\Client;

    $response = $client->post($api, array(
            'headers' => array(
